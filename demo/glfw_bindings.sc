...
let GLFWwindowiconifyfun = (sc_typename_type "GLFWwindowiconifyfun" pointer)
let GLFWwindow = (sc_typename_type "GLFWwindow" CStruct)
let GLFWerrorfun = (sc_typename_type "GLFWerrorfun" pointer)
let GLFWcursorposfun = (sc_typename_type "GLFWcursorposfun" pointer)
let GLFWscrollfun = (sc_typename_type "GLFWscrollfun" pointer)
let GLFWglproc = (sc_typename_type "GLFWglproc" pointer)
let GLFWcursor = (sc_typename_type "GLFWcursor" CStruct)
let GLFWwindowfocusfun = (sc_typename_type "GLFWwindowfocusfun" pointer)
let GLFWwindowclosefun = (sc_typename_type "GLFWwindowclosefun" pointer)
let GLFWcursorenterfun = (sc_typename_type "GLFWcursorenterfun" pointer)
let GLFWgammaramp = (sc_typename_type "GLFWgammaramp" CStruct)
let GLFWvkproc = (sc_typename_type "GLFWvkproc" pointer)
let GLFWwindowmaximizefun = (sc_typename_type "GLFWwindowmaximizefun" pointer)
let GLFWmousebuttonfun = (sc_typename_type "GLFWmousebuttonfun" pointer)
let GLFWvidmode = (sc_typename_type "GLFWvidmode" CStruct)
let GLFWwindowposfun = (sc_typename_type "GLFWwindowposfun" pointer)
let GLFWgamepadstate = (sc_typename_type "GLFWgamepadstate" CStruct)
let GLFWwindowsizefun = (sc_typename_type "GLFWwindowsizefun" pointer)
let GLFWimage = (sc_typename_type "GLFWimage" CStruct)
let GLFWframebuffersizefun = (sc_typename_type "GLFWframebuffersizefun" pointer)
let GLFWcharmodsfun = (sc_typename_type "GLFWcharmodsfun" pointer)
let GLFWcharfun = (sc_typename_type "GLFWcharfun" pointer)
let GLFWkeyfun = (sc_typename_type "GLFWkeyfun" pointer)
let GLFWwindowcontentscalefun = (sc_typename_type "GLFWwindowcontentscalefun" pointer)
let GLFWmonitor = (sc_typename_type "GLFWmonitor" CStruct)
let GLFWmonitorfun = (sc_typename_type "GLFWmonitorfun" pointer)
let GLFWjoystickfun = (sc_typename_type "GLFWjoystickfun" pointer)
let GLFWdropfun = (sc_typename_type "GLFWdropfun" pointer)
let GLFWwindowrefreshfun = (sc_typename_type "GLFWwindowrefreshfun" pointer)
...
let mutable@<u16> = (sc_pointer_type u16 18446744073709551613:u64 unnamed)
store (sc_key_type 'red mutable@<u16>) (getelementptr type-buffer 0)
store (sc_key_type 'green mutable@<u16>) (getelementptr type-buffer 1)
store (sc_key_type 'blue mutable@<u16>) (getelementptr type-buffer 2)
...
store (sc_key_type 'width i32) (getelementptr type-buffer 0)
store (sc_key_type 'height i32) (getelementptr type-buffer 1)
store (sc_key_type 'pixels mutable@<u8>) (getelementptr type-buffer 2)
...
let @<i8> = (sc_pointer_type i8 2:u64 unnamed)
store i32 (getelementptr type-buffer 0)
store @<i8> (getelementptr type-buffer 1)
...
let mutable@<GLFWwindow> = (sc_pointer_type GLFWwindow 18446744073709551613:u64 unnamed)
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
...
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
store i32 (getelementptr type-buffer 1)
store mutable@<@<i8>> (getelementptr type-buffer 2)
...
let mutable@<GLFWmonitor> = (sc_pointer_type GLFWmonitor 18446744073709551613:u64 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
store i32 (getelementptr type-buffer 1)
...
let mutable@<i32> = (sc_pointer_type i32 18446744073709551613:u64 unnamed)
let mutable@<mutable@<GLFWmonitor>> = (sc_pointer_type mutable@<GLFWmonitor> 18446744073709551613:u64 unnamed)
let mutable@<f32> = (sc_pointer_type f32 18446744073709551613:u64 unnamed)
let @<void> = (sc_pointer_type void 2:u64 unnamed)
let @<GLFWvidmode> = (sc_pointer_type GLFWvidmode 2:u64 unnamed)
let @<GLFWgammaramp> = (sc_pointer_type GLFWgammaramp 2:u64 unnamed)
let @<GLFWimage> = (sc_pointer_type GLFWimage 2:u64 unnamed)
let mutable@<f64> = (sc_pointer_type f64 18446744073709551613:u64 unnamed)
let mutable@<GLFWcursor> = (sc_pointer_type GLFWcursor 18446744073709551613:u64 unnamed)
let @<f32> = (sc_pointer_type f32 2:u64 unnamed)
let @<u8> = (sc_pointer_type u8 2:u64 unnamed)
let mutable@<GLFWgamepadstate> = (sc_pointer_type GLFWgamepadstate 18446744073709551613:u64 unnamed)
let mutable@<u32> = (sc_pointer_type u32 18446744073709551613:u64 unnamed)
...
store mutable@<i32> (getelementptr type-buffer 0)
store mutable@<i32> (getelementptr type-buffer 1)
store mutable@<i32> (getelementptr type-buffer 2)
let glfwGetVersion = (sc_global_new 'glfwGetVersion (sc_function_type void 3 type-buffer) 6 unnamed)
let glfwGetVersionString = (sc_global_new 'glfwGetVersionString (sc_function_type @<i8> 0 type-buffer) 6 unnamed)
store mutable@<@<i8>> (getelementptr type-buffer 0)
...
store mutable@<i32> (getelementptr type-buffer 0)
let glfwGetMonitors = (sc_global_new 'glfwGetMonitors (sc_function_type mutable@<mutable@<GLFWmonitor>> 1 type-buffer) 6 unnamed)
let glfwGetPrimaryMonitor = (sc_global_new 'glfwGetPrimaryMonitor (sc_function_type mutable@<GLFWmonitor> 0 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
store mutable@<i32> (getelementptr type-buffer 1)
store mutable@<i32> (getelementptr type-buffer 2)
...
store mutable@<i32> (getelementptr type-buffer 1)
store mutable@<i32> (getelementptr type-buffer 2)
store mutable@<i32> (getelementptr type-buffer 3)
store mutable@<i32> (getelementptr type-buffer 4)
...
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
store mutable@<f32> (getelementptr type-buffer 1)
store mutable@<f32> (getelementptr type-buffer 2)
let glfwGetMonitorContentScale = (sc_global_new 'glfwGetMonitorContentScale (sc_function_type void 3 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
let glfwGetMonitorName = (sc_global_new 'glfwGetMonitorName (sc_function_type @<i8> 1 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
...
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
let glfwGetMonitorUserPointer = (sc_global_new 'glfwGetMonitorUserPointer (sc_function_type @<void> 1 type-buffer) 6 unnamed)
...
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
store mutable@<i32> (getelementptr type-buffer 1)
let glfwGetVideoModes = (sc_global_new 'glfwGetVideoModes (sc_function_type @<GLFWvidmode> 2 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
let glfwGetVideoMode = (sc_global_new 'glfwGetVideoMode (sc_function_type @<GLFWvidmode> 1 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
store f32 (getelementptr type-buffer 1)
let glfwSetGamma = (sc_global_new 'glfwSetGamma (sc_function_type void 2 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
let glfwGetGammaRamp = (sc_global_new 'glfwGetGammaRamp (sc_function_type @<GLFWgammaramp> 1 type-buffer) 6 unnamed)
store mutable@<GLFWmonitor> (getelementptr type-buffer 0)
store @<GLFWgammaramp> (getelementptr type-buffer 1)
...
store i32 (getelementptr type-buffer 0)
store i32 (getelementptr type-buffer 1)
store @<i8> (getelementptr type-buffer 2)
store mutable@<GLFWmonitor> (getelementptr type-buffer 3)
store mutable@<GLFWwindow> (getelementptr type-buffer 4)
let glfwCreateWindow = (sc_global_new 'glfwCreateWindow (sc_function_type mutable@<GLFWwindow> 5 type-buffer) 6 unnamed)
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
...
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
store i32 (getelementptr type-buffer 1)
store @<GLFWimage> (getelementptr type-buffer 2)
...
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
let glfwGetWindowMonitor = (sc_global_new 'glfwGetWindowMonitor (sc_function_type mutable@<GLFWmonitor> 1 type-buffer) 6 unnamed)
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
store mutable@<GLFWmonitor> (getelementptr type-buffer 1)
store i32 (getelementptr type-buffer 2)
store i32 (getelementptr type-buffer 3)
store i32 (getelementptr type-buffer 4)
...
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
let glfwGetWindowUserPointer = (sc_global_new 'glfwGetWindowUserPointer (sc_function_type @<void> 1 type-buffer) 6 unnamed)
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
...
store i32 (getelementptr type-buffer 0)
store i32 (getelementptr type-buffer 1)
let glfwGetKeyName = (sc_global_new 'glfwGetKeyName (sc_function_type @<i8> 2 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
...
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
store mutable@<f64> (getelementptr type-buffer 1)
store mutable@<f64> (getelementptr type-buffer 2)
...
store @<GLFWimage> (getelementptr type-buffer 0)
store i32 (getelementptr type-buffer 1)
store i32 (getelementptr type-buffer 2)
let glfwCreateCursor = (sc_global_new 'glfwCreateCursor (sc_function_type mutable@<GLFWcursor> 3 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
let glfwCreateStandardCursor = (sc_global_new 'glfwCreateStandardCursor (sc_function_type mutable@<GLFWcursor> 1 type-buffer) 6 unnamed)
store mutable@<GLFWcursor> (getelementptr type-buffer 0)
let glfwDestroyCursor = (sc_global_new 'glfwDestroyCursor (sc_function_type void 1 type-buffer) 6 unnamed)
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
store mutable@<GLFWcursor> (getelementptr type-buffer 1)
...
store i32 (getelementptr type-buffer 0)
store mutable@<i32> (getelementptr type-buffer 1)
let glfwGetJoystickAxes = (sc_global_new 'glfwGetJoystickAxes (sc_function_type @<f32> 2 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
store mutable@<i32> (getelementptr type-buffer 1)
let glfwGetJoystickButtons = (sc_global_new 'glfwGetJoystickButtons (sc_function_type @<u8> 2 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
store mutable@<i32> (getelementptr type-buffer 1)
let glfwGetJoystickHats = (sc_global_new 'glfwGetJoystickHats (sc_function_type @<u8> 2 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
let glfwGetJoystickName = (sc_global_new 'glfwGetJoystickName (sc_function_type @<i8> 1 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
let glfwGetJoystickGUID = (sc_global_new 'glfwGetJoystickGUID (sc_function_type @<i8> 1 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
store @<void> (getelementptr type-buffer 1)
let glfwSetJoystickUserPointer = (sc_global_new 'glfwSetJoystickUserPointer (sc_function_type void 2 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
let glfwGetJoystickUserPointer = (sc_global_new 'glfwGetJoystickUserPointer (sc_function_type @<void> 1 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
...
store @<i8> (getelementptr type-buffer 0)
let glfwUpdateGamepadMappings = (sc_global_new 'glfwUpdateGamepadMappings (sc_function_type i32 1 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
let glfwGetGamepadName = (sc_global_new 'glfwGetGamepadName (sc_function_type @<i8> 1 type-buffer) 6 unnamed)
store i32 (getelementptr type-buffer 0)
store mutable@<GLFWgamepadstate> (getelementptr type-buffer 1)
...
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
let glfwGetClipboardString = (sc_global_new 'glfwGetClipboardString (sc_function_type @<i8> 1 type-buffer) 6 unnamed)
...
let glfwGetCurrentContext = (sc_global_new 'glfwGetCurrentContext (sc_function_type mutable@<GLFWwindow> 0 type-buffer) 6 unnamed)
store mutable@<GLFWwindow> (getelementptr type-buffer 0)
...
store mutable@<u32> (getelementptr type-buffer 0)
let glfwGetRequiredInstanceExtensions = (sc_global_new 'glfwGetRequiredInstanceExtensions (sc_function_type mutable@<@<i8>> 1 type-buffer) 6 unnamed)
do
